...
class _$ProductImpl implements _Product {
  const _$ProductImpl(
      ...
      @HiveField(4) final List<String> categories = const [],
  ...
  @override
  String toString() {
    return 'Product(id: $id, name: $name, price: $price, stock: $stock, categories: $categories, createdAt: $createdAt)';
  }
...
abstract class _Product implements Product {
  const factory _Product(
      ...
      @HiveField(5) required final DateTime createdAt}) = _$ProductImpl;
